...
class Diagnosis(CustomBaseModel):
    ...
    model_id: Optional[str] = Field(None, alias="modelId", description="모델 ID")
    discriminator_key: Optional[str] = Field(None, alias="discriminatorKey", description="Discriminator 키 (e.g., 'iou_threshold')")
    discriminator_values: Optional[List[str]] = Field(None, alias="discriminatorValues", description="Discriminator 값 목록 (e.g., ['0.5', '0.75', '0.9'])")
